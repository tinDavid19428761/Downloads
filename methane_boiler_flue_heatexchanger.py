...
m.fs.M101.methane_feed.temperature.fix(300)
...
#heater (H101) modelling:
#steam generation mass energy balance:
...
steam_gen = -value(m.fs.R101.heat_duty[0])/(enth_out-enth_in)

#heater modelling is display purposes, actual calculation is above
m.fs.H101.inlet.flow_mol.fix(steam_gen)
...
m.fs.H101.report()
m.fs.E101.report()
print(f"{steam_gen: .5f} mol/s of steam is generated")
